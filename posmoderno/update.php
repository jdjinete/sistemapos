...
function database_import() 
{
    ...
    $version = isset($info['version']) ? $info['version'] : '3.2';
...
<html lang="en">
  <head>
    ...
    <title>Update from v3.2 to v3.3 - <?php echo APPNAME;?></title>
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-default header" style="">
                <div class="panel-heading text-center">
                    <h2>Update Modern POS from v3.2 to v3.3</h2>
                    <h1>STEP 
                        ...
                        <?php if (isset($request->get['update']) && $request->get['update'] == 'yes'):
                            ...
                            ?>
                                <label for="database" class="col-sm-3 control-label">
                                    <p>Database Name <small>of v3.2</small> <span class="text-aqua">*</span></p>
                                </label>
                                <div class="col-sm-7">
      ...
      success: function(json) {
        ...
        if (json["success"]) {
            window.swal({
              ...
              text:  "Contratulations, System updated to version 3.3. Please, Delete update.php file for security purpose.",
              type: "success",
